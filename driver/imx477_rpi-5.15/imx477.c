...
/* RPi downstream metadata mbus code, absent from mainline/Ubuntu 5.15 headers */
...
static const struct imx477_reg mode_1332x990_regs[] = {
	...
	{0x0822, 0x00},
	{0x0823, 0x00},
	/* TCLKPOST/TCLKZERO/TCLKTRAIL bumped ~40% above RPi-driver stock
	 * values as an empirical test of AMD PG232's stricter TCLK-POST
	 * margin requirement (needs 160ns @ 900Mbps vs generic D-PHY spec's
	 * 118ns; exact register->ns scale factor undocumented, so testing
	 * the hypothesis directly rather than computing it -- see
	 * EXPERIMENT_LOG.md 2026-09-14 TCLKPOST entry).
	 * Stock: TCLK_POST_EX=0x007f(127) TCLK_TRAIL_MIN=0x0057(87)
	 *        TCLK_ZERO_EX=0x0127(295). Only mode_1332x990_regs touched
	 * (the only mode this project uses; verified mode_common_regs does
	 * not also set these addresses).
	 */
	{0x080a, 0x00},
	{0x080b, 0x7f},		/* TCLK_POST_EX: stock (127) -- reverted for baseline re-check */
	{0x080c, 0x00},
	{0x080d, 0x4f},
	{0x080e, 0x00},
	{0x080f, 0x77},
	...
	{0x0811, 0x5f},
	{0x0812, 0x00},
	{0x0813, 0x57},		/* TCLK_TRAIL_MIN: stock (87) -- reverted for baseline re-check */
	{0x0814, 0x00},
	{0x0815, 0x4f},
	{0x0816, 0x01},
	{0x0817, 0x27},		/* TCLK_ZERO_EX: stock (295) -- reverted for baseline re-check */
	{0x0818, 0x00},
	{0x0819, 0x3f},
	{0xe04c, 0x00},
	{0xe04d, 0x5f},
